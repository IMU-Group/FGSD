...
class DIMModel(nn.Module):
    def __init__(self, is_unpooling=True, pretrain=True):
        ...
        # self.down5 = segnetDown3(1024, 1024)
        #
        # self.up5 = segnetUp1(1024, 1024)
        # self.up4 = segnetUp1(1024, 512)
        # self.up3 = segnetUp1(512, 256)
        # self.up2 = segnetUp1(256, 128)
        # self.up1 = segnetUp1(128, n_classes)
...
if __name__ == '__main__':
    ...
    logist = model(torch.randn(2, 32, 256, 256).to(device))
    print(logist.size())